...
namespace amongus
{
    ...
    {
        Program(){}
        public static string susasciiart = @"
        ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠿⠿⠿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
        ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠟⠁⠀⠀⠀⠀⠀⠈⠻⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
        ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠯⠀⡖⠒⠒⠠⠤⣄⡀⠀⢹⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
        ⣿⣿⣷⣶⡆⣶⣶⣿⡏⣦⢁⣄⢿⣿⢰⣶⣶⡌⣿⡏⢰⣶⣦⡄⢠⠇⠀⠀⠀⠀⠀⠈⠑⢳⣦⣽⣿⢱⣶⣶⡌⣿⡇⢰⣶⣶⠈⣿⣿⣿
        ...
        public static string[] vents = new string[]
        {
        ...
        {
            string sus; // will be used for inputs in the console
            Console.OutputEncoding = System.Text.Encoding.UTF8; // sets console's output encoding to UTF-8
            while(true)
            {
